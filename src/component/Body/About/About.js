    ...
    if(props.show)
    {
        about = (
            <div className = {classes.AboutContainer}>
                <h2>About me</h2>
                <div className = {classes.ImageDiv}><img src = {MyPic}/></div>
                <div className = {classes.Content}>
                    <p>I live and work in <a href = "https://www.google.com/maps/place/Bareilly,+Uttar+Pradesh/@28.3760609,79.3518995,12z/data=!3m1!4b1!4m5!3m4!1s0x39a007334d02998d:0x5b9d44cf31ee87f!8m2!3d28.3670355!4d79.4304381?hl=en" target = "_blank">Bareilly, Uttar Pradesh</a>.<br/> I freelance when I can, mostly building custom websites that you can’t get from a template.
