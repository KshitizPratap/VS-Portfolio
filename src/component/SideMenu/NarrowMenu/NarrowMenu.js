...
const narrowMenu = (props) => {
    ...
    <div className={classes.NarrowMenuContainer}>
        <div className={classes.wrapper}>
            <Link to = "/VS-Portfolio" style={{color : "white"}}>
            <div 
            ...
            <Link to = "/VS-Portfolio/Contact" style={{color : "white"}}>
            <div 
